...
trait MacroApplication {
   ...
   *
   * WARN: No Licence, the original class presented here:
   * https://github.com/b-studios/objectalgebras/blob/master/core/src/main/scala/objectalgebras/utils/macroapplication.scala
   */
  case class MacroApp (name: String,
